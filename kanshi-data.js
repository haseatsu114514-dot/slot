...
// 日本の祝日 (内閣府発表ベース)。国民の休日・振替休日も含む。
// カバー範囲: 2024-01-01 〜 2027-12-31。範囲外は null を返す。
export const JAPANESE_HOLIDAYS = Object.freeze({
  "2024-01-01": "元日",
  "2024-01-08": "成人の日",
  "2024-02-11": "建国記念の日",
  "2024-02-12": "振替休日",
...
export function getHoliday(dateKey) {
  ...
  const name = JAPANESE_HOLIDAYS[dateKey];
  return name ? { name, dateKey } : null;
}
